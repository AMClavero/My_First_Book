...
## What is this?
This is the course material and a template designed for the teaching staff of the **Faculties of Sciences and Chemical Sciences at USAL** to create interactive teaching books easily. The main idea of this template is that it is broad enough to cover many use cases and for each student to adapt it to their own course, while being simple to use with the help of AI assistants (such as GitHub Copilot, Gemini, Claude, Codex, etc.) and a code editor like VS Code.
